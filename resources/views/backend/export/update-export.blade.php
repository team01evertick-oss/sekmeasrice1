...
@section('content')
    ...
    @section('page-main-title')
        UPDATE PRODUCT FOR EXPORT
    @endsection

    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <form action="{{ route('submit.update.export') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="grid grid-cols-2 gap-10">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <input class="form-control" type="text" name="update_brand" value="{{ old('brand'). $row->brand }}">
                                        @error('brand')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                    </div>
                                    {{-- Product Name --}}
                                    <div class="mb-3 col-12">
                                        <label class="form-label text-[#0F4634]">Name</label>
                                        <input class="form-control" type="text" name="update_name" value="{{ old('name'). $row->name  }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="flex gap-4">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <img id="thumbnailPreview" src="{{ asset('storage/local_product/' . $row->image_export) }}"
                                           ...
                                           <input type="hidden" name="old_image_export" value="{{ $row->image_export }}">
                                                <input id="thumbnailFile" type="file" name="update_image_export" accept="image/*"
                                                    class="hidden" />
                                        </label>
