...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="{{ route('submit.update.localsales') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="grid grid-cols-2 gap-10">
                                    <div>
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <input class="form-control" type="text" name="update_brand"
                                                value="{{ old('brand') . $localSale->brand }}">
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <input class="form-control" type="text" name="update_name"
                                                value="{{ old('name') . $localSale->name }}">
                                            @error('name')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                                        </div>
                                        {{-- Type of Product --}}
                                        <div class="mb-3 col-12">
                                            <label class="form-label text-[#0F4634]">Type of crop (New or Old)</label>
                                            <input class="form-control" type="text" min="1" name="update_type"
                                                value="{{ old('type') . $localSale->type }}">
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <input class="form-control" type="number" step="0.01" min="0"
                                                name="update_price" value="{{ old('price') . $localSale->price }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-4">
                                            ...
                                            <div class="mb-5">
                                                <label class="block mb-2 text-sm font-medium text-[#0F4634]">Image Product
                                                    of
                                                    Local</label>
                                                <label for="thumbnailFile"
                                                    ...
                                                    <img id="thumbnailPreview"
                                                        src="{{ asset('storage/local_product/'. $localSale->image_local) }}"
                                                        class="absolute inset-0 m-auto w-[250px] h-[350px] object-contain" />
                                                    ...
                                                    <input type="hidden" name="old_image_local"
                                                        value="{{ $localSale->image_local }}">
                                                    <input id="thumbnailFile" type="file" name="update_image_local"
